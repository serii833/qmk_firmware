...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
                                    ...
                                    KC_PGUP, KC_PGDN,
                                                        // right hand
                                                              ...
                                                              KC_RBRC, KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
                                                                     ...
                                                                     KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SPC, KC_LALT,
    ...
    //                                                                    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
    //
    //                                                                  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_ENT, KC_SPC,
    //                                                                  // XXXXXXX,  KC_RALT,   KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,
    //                                                  XXXXXXX, KC_RALT,
    //                                                  KC_HOME, KC_END
    // ),
        ...
        _______,   _______, _______,  _______,   _______, _______,
                                    ...
                                    _______, _______,
                                                                    // right hand
                                                                          ...
                                                                          _______, KC_PSLS, KC_7,    KC_8,    KC_9,    KC_PMNS, XXXXXXX,
                                                                          _______, KC_PAST, KC_4,    KC_5,    KC_6,    KC_PPLS, XXXXXXX,
                                                                                   XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX, XXXXXXX,
                                                                                   KC_DOT, KC_DOT, XXXXXXX, XXXXXXX, XXXXXXX, KC_0,
                                                                     XXXXXXX, _______,
                                                                     _______, _______
    ),
    ...
    [_NAV] = LAYOUT_5x7(
        // left hand
        KC_NUM,    KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   XXXXXXX,
        ...
        XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX, XXXXXXX,
                                    ...
                                    XXXXXXX, XXXXXXX,
                                                                    // right hand
                                                                          XXXXXXX, KC_F6,   KC_F7,    KC_F8,   KC_F9,    KC_F10,  KC_PSCR,
                                                                          XXXXXXX, KC_F11,  KC_F12,   XXXXXXX, XXXXXXX,  XXXXXXX, KC_CALC,
                                                                          XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,
                                                                                   XXXXXXX, XXXXXXX,  KC_VOLD, KC_VOLU,  KC_MUTE, XXXXXXX,
                                                                                   XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX, KC_APP,
                                                                     XXXXXXX, XXXXXXX,
                                                                     XXXXXXX, XXXXXXX
    )
